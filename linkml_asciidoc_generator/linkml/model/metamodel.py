...
class Setting(ConfiguredBaseModel):
    ...
    setting_key: str = Field(..., description="""the variable name for a setting""")
    setting_value: str = Field(..., description="""The value assigned for a setting""")
...
class AltDescription(ConfiguredBaseModel):
    ...
    source: str = Field(..., description="""the source of an attributed description""")
    description: str = Field(..., description="""text of an attributed description""")
